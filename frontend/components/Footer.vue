<template>
  <footer class="border-t bg-background py-8 px-4 sm:px-6 lg:px-8 mt-16">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div class="flex items-center gap-4">
        <a href="https://x.com/briancaffey" target="_blank" rel="noopener" aria-label="X / Twitter" class="hover:text-primary transition">
          𝕏
        </a>
        <a href="https://discord.gg/4fVcmJq4X" target="_blank" rel="noopener" aria-label="Discord" class="hover:text-primary transition">
        ...
        <a href="https://github.com/inference-club" target="_blank" rel="noopener" aria-label="GitHub" class="hover:text-primary transition">
